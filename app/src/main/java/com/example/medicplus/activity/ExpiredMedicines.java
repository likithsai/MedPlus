...
public class ExpiredMedicines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expired_medicines);
        ...
        db = new DatabaseHandler(ExpiredMedicines.this);
    ...
    private void loadExpiredMedicines() {
        outOfStock =  db.getExpiredMedicine();
        outofmedicines_count.setText("" + new DatabaseHandler(ExpiredMedicines.this).getExpiredMedicinesCount());
        ...
        lAdapter = new ListAdapterMedicines(ExpiredMedicines.this, med_name, med_category, med_expired_date, med_selling_price, med_qty, med_images);
        ...
        outOfStockListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                BottomSheetDialog dialog = new BottomSheetDialog(ExpiredMedicines.this);
                ...
                but_delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        new AlertDialog.Builder(ExpiredMedicines.this)
                ...
                but_edit.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent addStore = new Intent(ExpiredMedicines.this, AddMedicines.class);
        ...
        txtOutOfStockMedicines.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                outofmedicines_count.setText("" + new DatabaseHandler(ExpiredMedicines.this).searchOutOfStockMedicineCount(s.toString()));
