...
public class ListAdapterManufacturer extends BaseAdapter {
...
//    public ListAdapterManufacturer(Context context, String[] name, String[] category, Bitmap[] images){
...
//    }
    ...
    public ListAdapterManufacturer(MainActivity context, ArrayList<String> name, ArrayList<String> category, ArrayList<Bitmap> images) {
        this.context = context;
        this.name = name;
        this.category = category;
        this.images = images;
...
//    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_listview_manufacturer, parent, false);
